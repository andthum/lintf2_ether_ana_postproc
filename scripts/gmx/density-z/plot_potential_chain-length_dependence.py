...
as function of the distance to the electrodes for different chain
lengths.
...
if args.surfq == "q0":
    ...
    ymin = ((-17, None, None), (-14, None, None))
    ymin += ((None, None, None),)
    ymax = ((10, None, None), (11, None, None))
    ymax += ((None, None, None),)
elif args.surfq == "q0.5":
    ymin = ((-32, None, None), (-22, None, None))
    ymin += ((None, None, None),)
    ymax = ((18, None, None), (16, None, None))
    ymax += ((None, None, None),)
elif args.surfq == "q0.75":
    ymin = ((-50, None, None), (-26, None, None))
    ymin += ((None, None, None),)
    ymax = ((30, None, None), (18, None, None))
    ymax += ((None, None, None),)
elif args.surfq == "q1":
    ymin = ((-65, None, None), (-20, None, None))
    ymin += ((None, None, None),)
