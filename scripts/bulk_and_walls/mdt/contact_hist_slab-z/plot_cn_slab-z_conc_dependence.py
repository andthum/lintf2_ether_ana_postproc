...
of the distance to the electrodes for different salt concentrations.
"""
...
parser = argparse.ArgumentParser(
    description=(
        ...
        " function of the distance to the electrodes for different salt"
        " concentrations."
    )
)
parser.add_argument(
...
if args.common_ylim:
    if args.cmp == "Li-OE":
        ...
        ylim = (0, 3.4)  # (0, 3.2) No place for legend.
...
n_legend_cols = 1 + Sims.n_sims // (2 + 1)
...
with PdfPages(outfile) as pdf:
    for plt_sec in plot_sections:
        ...
        if plt_sec == "left":
            ...
            legend_loc = "center"
        if cmp2 == "OE" or (cmp2 == "PEO" and args.sol == "g1"):
