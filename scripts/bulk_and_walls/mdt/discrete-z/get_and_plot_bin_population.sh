...
information() {
    ...
    echo "the Python script get_and_plot_bin_population.py to calculate"
    echo "and plot the number of compounds per bin."
}
...
usage() {
    ...
    echo "  -c    The compound for which to calculate and plot the bin"
    echo "        population.  Default: '${cmp}'."
}
...
py_script=$(readlink -e "${script_dir}/get_and_plot_bin_population.py" || exit)
