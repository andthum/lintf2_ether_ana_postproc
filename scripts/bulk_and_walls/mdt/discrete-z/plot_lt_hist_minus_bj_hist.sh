...
information() {
    ...
    echo "the Python script plot_lt_hist_minus_bj_hist.py to plot the"
    echo "difference of the sum of the lifetime histograms of adjacent"
    echo "bins obtained from the uncensored count method and the"
    echo "back-jump histogram for each bin."
}
...
usage() {
    ...
    echo "        to parse to 'plot_lt_hist_minus_bj_hist.py' as one long,"
...
py_script=$(readlink -e "${script_dir}/plot_lt_hist_minus_bj_hist.py" || exit)
